...
const ReferAndEarn = () => {
    return (
        <main >
            <div className='refer__contain'>
                <div className='refer__dashboard'>
                    <div className='ref_dash_details'>
                        <div>
                            <h6>Referal Earning</h6>
                            <p>₹{data.ref_earn}</p>
                        </div>
                        <div>
                            <h6>Total Referal</h6>
                        ...
                        <div className='refer__btn'>
                            <button className='withdraw_btn'>Withdraw Balance</button>
                        </div>
                    </div>
                </div>
                <div className='refer__code'>
                    <h3>Your Referral Code</h3>
                    <span>{data.ref_code}</span>
                </div>
            </div>
            <div className='hdw__contain'>
                <h3>How does it work?</h3>
                <div className="hdw__items">
                    <div className="hdw__box">
                    ...
                    <div className="hdw__box">
                        ...
                        <span className='details__span'>
                            ...
                            <p>
                                Using you REFERRAL CODE in the payment page
                            </p>
                        </span>
                    </div>
                    <div className="hdw__box">
                    ...
                    <div className="hdw__box">
                        <span className='icon__span'>
                            <svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M24 20V21.3333C24 22.8 22.8 24 21.3333 24H2.66667C1.18667 24 0 22.8 0 21.3333V2.66667C0 1.2 1.18667 0 2.66667 0H21.3333C22.8 0 24 1.2 24 2.66667V4H12C10.52 4 9.33333 5.2 9.33333 6.66667V17.3333C9.33333 18.8 10.52 20 12 20H24ZM12 17.3333H25.3333V6.66667H12V17.3333ZM17.3333 14C16.2267 14 15.3333 13.1067 15.3333 12C15.3333 10.8933 16.2267 10 17.3333 10C18.44 10 19.3333 10.8933 19.3333 12C19.3333 13.1067 18.44 14 17.3333 14Z" fill="url(#paint0_linear_3821_13653)" />
                                <defs>
                                    <linearGradient id="paint0_linear_3821_13653" x1="25.3333" y1="12" x2="1.35156e-07" y2="12" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#800080" />
                                        <stop offset="1" stop-color="#FF864C" />
                                    </linearGradient>
                                </defs>
            ...
            <Link to='./friendsrefered' style={{textDecoration: 'none'}} className='bottom__text'>Friend who enrolled</Link>

            <h3 className='bottom__text'>Terms & Conditions</h3>
        </main>
    )
}
